...
# ning.wei@hmd++ begin
ifeq ($(TARGET_PRODUCT),ShadowcatPlus_Natv)
    KBUILD_CFLAGS += -DTARGET_PRODUCT_SCP
endif

ifeq ($(TARGET_PRODUCT),Shadowcat_Natv)
    KBUILD_CFLAGS += -DTARGET_PRODUCT_SCT
endif
# ning.wei@hmd++ end

#Added by qinjinke@sagereal.com for TARGET_PRODUCT_MGK Begin 2022-03-25
ifeq ($(TARGET_PRODUCT),Magik_Natv)
    KBUILD_CFLAGS += -DTARGET_PRODUCT_MGK
endif
#Added by qinjinke@sagereal.com for TARGET_PRODUCT_MGK End 2022-03-25
