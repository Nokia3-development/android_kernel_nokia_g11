			...
			const char *buf, size_t count)
{
	...
	//dpu->core->modeset(ctx, &panel->info.mode);
...
/*Modified by gonglinmin@sagereal.com for MGK-2943 Screen flash Begin 2022-05-31*/
...
static BIN_ATTR_WO(slp_video, 48);
#endif
/*Modified by gonglinmin@sagereal.com for MGK-2943 Screen flash end 2022-05-31*/
