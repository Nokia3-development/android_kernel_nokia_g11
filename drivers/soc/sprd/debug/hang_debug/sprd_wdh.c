...
#define sprd_virt_addr_valid(kaddr) ((void *)(kaddr) >= (void *)PAGE_OFFSET && \
					...
					pfn_valid(__pa(kaddr) >> PAGE_SHIFT))
#endif
//Modify by gonglinmin@sagereal.com for MGK-820 Close UART Log  Begin 2022-6-1
...
#endif
//Modify by gonglinmin@sagereal.com for MGK-820 Close UART Log  end 2022-6-1
