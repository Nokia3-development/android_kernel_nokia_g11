...
#endif
#ifndef TARGET_PRODUCT_MGK
//Add by hechaofan,add node : real_type begin
...
//Add by hechaofan ,add node : real_type end
//Add by hechaofan ,add node : typec_cc_orientation begin
...
//Add by hechaofan, add node : typec_cc_orientation end
#endif
				   ...
				   bool ws)
{
	...
	int i, rc;
	#ifndef TARGET_PRODUCT_MGK
	int ret_device_file = 0;	//Add by hechaofan,add node : real_type
	#endif
	if (!parent)
