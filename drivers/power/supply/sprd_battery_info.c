...
int sprd_battery_get_battery_info(struct power_supply *psy, struct sprd_battery_info *info)
{
	...
	//Modify by xushengjie to enable SCP&SCT charging function on 2022-04-29 begin
	#if !defined(TARGET_PRODUCT_SCP) && !defined(TARGET_PRODUCT_SCT)
	if (strcmp("simple-battery", value))
		return -ENODEV;
	#endif
	//Modify by xushengjie to enable SCP&SCT charging function on 2022-04-29 end
