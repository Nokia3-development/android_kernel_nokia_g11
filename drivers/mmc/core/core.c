...
//Modify by yuan_nian for SCP-5151 BEGIN 2022-07-04
#ifdef PRODUCT_SHADOWCAT
	return UINT_MAX;
#endif
//Modify by yuan_nian for SCP-5151 END 2022-07-04
	//modify by baicongrong for [MGK-1547/2310]512G SD Card format fail begin
    if (mmc_card_sd(card) && mmc_card_uhs(card))
            return UINT_MAX;
    //modify by baicongrong for [MGK-1547/2310]512G SD Card format fail end
